...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "Proszę wprowadzić jedynie cyfry.",
		creditcard: "Proszę wprowadzić prawidłowy numer karty.",
		equalTo: "Proszę wprowadzić tą samą wartość.",
		accept: "Proszę wprowadzić wartość z prawidłowym rozszerzeniem.",
		...
		rangelength: $.validator.format("Proszę wprowadzić wartość o długości znaków między {0} a {1}."),
		range: $.validator.format("Proszę wprowadzić wartość między {0} a {1}."),
